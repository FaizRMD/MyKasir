...
## Lampiran: Tabel Uji (Format Seperti Contoh Gambar)

Catatan: Kolom "Actual Results" dan "Pass/Fail" diisi saat eksekusi.

### A. Manajemen Pengguna (Admin Membuat Akun)

| Test Case ID | Test Scenario                              | Test Steps                                                                                                                                          | Test Data                                        | Expected Results                                                                                 | Actual Results | Pass/Fail |
|--------------|--------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|--------------------------------------------------------------------------------------------------|---------------|-----------|
| U1           | Buat user baru dengan data valid           | 1. Akses halaman Create Pengguna (admin/users/create)<br>2. Isi nama, email, password, konfirmasi, pilih role kasir<br>3. Klik Simpan               | Nama: Kasir Budi<br>Email: kasir1@test.com<br>Password: Kasir@123<br>Confirm: Kasir@123<br>Role: kasir | User berhasil dibuat, redirect dengan pesan sukses; user memiliki role kasir                        |               |           |
| U2           | Registrasi user dengan email duplikat      | 1. Akses halaman Create Pengguna<br>2. Isi email yang sudah terdaftar<br>3. Klik Simpan                                                             | Email: admin@test.com (sudah ada)               | Muncul pesan validasi email sudah digunakan; user tidak tersimpan                                 |               |           |
| U3           | Password terlalu lemah (< 8 karakter)      | 1. Akses halaman Create Pengguna<br>2. Isi password < 8 dan konfirmasi sama<br>3. Klik Simpan                                                       | Password: 12345<br>Confirm: 12345               | Muncul pesan validasi minimum panjang 8; user tidak tersimpan                                     |               |           |
| U4           | Password dan konfirmasi tidak sama         | 1. Akses halaman Create Pengguna<br>2. Isi password dan konfirmasi berbeda<br>3. Klik Simpan                                                        | Password: Kasir@123<br>Confirm: Kasir@321       | Muncul pesan validasi konfirmasi tidak cocok; user tidak tersimpan                                |               |           |
| U5           | Role tidak dipilih                         | 1. Akses halaman Create Pengguna<br>2. Kosongkan pilihan role<br>3. Klik Simpan                                                                     | Role: (kosong)                                   | Muncul pesan validasi role wajib; user tidak tersimpan                                            |               |           |

### B. Penerimaan Barang (Goods Receipt)

| Test Case ID | Test Scenario                              | Test Steps                                                                                                                                                                | Test Data                                                                                   | Expected Results                                                                                                      | Actual Results | Pass/Fail |
|--------------|--------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|---------------|-----------|
| G1           | Simpan GRN sebagai draft (stok tidak naik) | 1. Akses Create GRN dari PO<br>2. Isi tanggal terima<br>3. Isi qty ≤ outstanding per item<br>4. Isi batch/exp opsional<br>5. Klik Simpan                                   | Item A: qty PO 10, terima 6<br>Item B: qty PO 5, terima 5                                  | GRN tersimpan status draft; tidak ada perubahan `product.stock`; `pembelian_items.qty_received` tetap 0               |               |           |
| G2           | Approve GRN (stok bertambah)               | 1. Buka detail GRN draft<br>2. Klik Approve dan konfirmasi                                                                                                                | GRN hasil G1                                                                             | Status GRN berubah ke received; stok A +6, stok B +5; `qty_received` item PO ter-update; status PO jadi partial_received |               |           |
| G3           | Approve ulang GRN yang sudah received      | 1. Buka detail GRN received<br>2. Klik Approve lagi                                                                                                                        | GRN hasil G2                                                                             | Tampil info "sudah dikonfirmasi"; stok & qty_received tidak berubah                                                  |               |           |
| G4           | Hapus GRN draft                            | 1. Buka detail GRN draft<br>2. Klik Hapus dan konfirmasi                                                                                                                  | GRN draft                                                                               | GRN terhapus; stok & qty_received tidak berubah                                                                      |               |           |
| G5           | Hapus GRN received (revert stok & qty)     | 1. Buka detail GRN received<br>2. Klik Hapus dan konfirmasi                                                                                                                | GRN received                                                                            | Stok berkurang sesuai qty GRN; `qty_received` dikurangi; status PO dihitung ulang (partial/draft)                      |               |           |
| G6           | Validasi qty melebihi outstanding          | 1. Akses Create GRN<br>2. Isi qty > outstanding<br>3. Klik Simpan                                                                                                          | Outstanding A: 4, diisi 10                                                              | Muncul pesan validasi; data tidak tersimpan                                                                           |               |           |

### C. Kasir/POS

| Test Case ID | Test Scenario               | Test Steps                                                                                                                                     | Test Data                                      | Expected Results                                                       | Actual Results | Pass/Fail |
|--------------|-----------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|------------------------------------------------------------------------|---------------|-----------|
| P1           | Tambah item ke cart         | 1. Buka halaman POS<br>2. Cari produk<br>3. Set qty<br>4. Tambah ke cart                                                                     | Produk: Paracetamol 500mg<br>Qty: 2            | Item masuk cart; subtotal = qty * harga                                 |               |           |
| P2           | Checkout transaksi          | 1. Pastikan ada item di cart<br>2. Pilih metode bayar<br>3. Klik Checkout                                                                     | Bayar: Cash                                    | Transaksi tersimpan; stok berkurang sesuai qty; struk tersedia          |               |           |
| P3           | Stok tidak mencukupi        | 1. Cari produk stok 5<br>2. Set qty 10<br>3. Checkout                                                                                         | Produk stok 5; Qty: 10                          | Muncul error "insufficient stock"; transaksi dibatalkan                 |               |           |

### D. Purchase Order (PO)

| Test Case ID | Test Scenario                 | Test Steps                                                                                                                                       | Test Data                                                    | Expected Results                                  | Actual Results | Pass/Fail |
|--------------|-------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|---------------------------------------------------|---------------|-----------|
| O1           | Buat PO baru                  | 1. Buka Create PO<br>2. Pilih supplier<br>3. Tambah item (produk, qty, harga)<br>4. Simpan                                                     | Supplier: PT ABC<br>Item: Para 100 @ 5000                    | PO tersimpan; status awal draft/ordered           |               |           |
| O2           | Edit qty/harga PO             | 1. Buka detail PO<br>2. Edit qty/harga item<br>3. Simpan                                                                                                   | Ubah qty: 100 → 120                                          | Total dihitung ulang; data ter-update             |               |           |
| O3           | Print blanko PO               | 1. Buka detail PO<br>2. Klik Print Blanko                                                                                               | -                                                            | PDF blanko ter-generate tanpa error               |               |           |

### E. Laporan

| Test Case ID | Test Scenario                | Test Steps                                                                                                  | Test Data                               | Expected Results                                       | Actual Results | Pass/Fail |
|--------------|------------------------------|-------------------------------------------------------------------------------------------------------------|-----------------------------------------|--------------------------------------------------------|---------------|-----------|
| R1           | Laporan Penjualan (filter)   | 1. Buka Reports > Sales<br>2. Isi range tanggal<br>3. Klik submit                                          | 01/12/2025 - 15/12/2025                 | Sales pada rentang tampil sesuai                        |               |           |
| R2           | Export PDF Sales             | 1. Buka Reports > Sales<br>2. Klik Export PDF                                                               | -                                       | PDF terunduh tanpa error                                 |               |           |
| R3           | Laporan Pembelian (detail)   | 1. Buka Reports > Pembelian<br>2. Klik salah satu pembelian<br>3. Lihat detail                              | Pembelian dengan GRN terkait             | Detail item, total, GRN terkait tampil                  |               |           |
| R4           | Laporan Expired              | 1. Buka Reports > Expired<br>2. Filter bulan depan<br>3. Klik submit                                        | Jan 2026                                 | Produk yang akan expired tampil                         |               |           |
| R5           | Laporan Supplier             | 1. Buka Reports > Supplier<br>2. Isi supplier<br>3. Klik submit                                             | Supplier: PT ABC                         | Riwayat transaksi supplier tampil                       |               |           |

---

Gunakan tabel-tabel di atas untuk eksekusi pengujian manual. Jika Anda ingin saya pecah per halaman dan menambahkan lebih banyak skenario, beri tahu modul prioritasnya.
